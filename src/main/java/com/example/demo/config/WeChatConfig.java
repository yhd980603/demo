...
public class WeChatConfig {
    ...
    public String getOpenRedireUrl() {
        return openRedireUrl;
    }

    public void setOpenRedireUrl(String openRedireUrl) {
        this.openRedireUrl = openRedireUrl;
    }
